...
return (
    <div
        className={cn(
        "w-full h-full max-w-xs sm:max-w-sm md:max-w-md lg:w-[500px] h-[500px] cursor-pointer overflow-hidden bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.02)] border border-gray-200/80",
        className
        )}
        >
            {image && (
            <div className="relative h-80 rounded-xl shadow-lg mx-2 mt-2">
                <img
                src={image}
                alt="card"
            ...
            <div className="flex justify-center items-center w-full pb-10">
                <button className="w-full text-sm rounded-xl py-2 mx-5 mb-3 mt-3 bg-blue-500">
                    Apply Now
                </button>
            </div>
        ...
        return (
          ...
          >
            <Card
              ...
              image={card.image}
            >
              <h2 className="text-black text-xl">{card.title}</h2>
